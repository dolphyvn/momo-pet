...
/// The Direction-C rig's FrontPaws layer group(s) (04 §2.2).
///
...
extension MomoRig {
    ...
    /// **pawLeft** - FrontPaws group.
    /// Channels: position/rotation (peek, pat, refuse-raise).
    /// Left front paw resting on the belly's lower front, clear of the hind feet at rest.
    public static let pawLeft: Path = Path { p in
    ...
    /// **pawRight** - FrontPaws group.
    /// Channels: position/rotation (peek, pat, refuse-raise).
    /// Right front paw resting on the belly's lower front, clear of the hind feet at rest.
    public static let pawRight: Path = Path { p in
